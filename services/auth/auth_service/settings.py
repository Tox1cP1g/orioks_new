...
SIMPLE_JWT.update({
    ...
    'ADDITIONAL_CLAIMS': {
        'role': lambda user: user.role,
        'full_name': lambda user: user.get_full_name(),
        'student_id': lambda user: user.student_id,
        'department': lambda user: user.department,
        'position': lambda user: user.position,
    }
})
