...
### Интеграция между порталами
- Импорт преподавателей из преподавательского портала в студенческий портал
- Импорт предметов из преподавательского портала в студенческий портал
- Импорт связей преподаватель-предмет из преподавательского портала в студенческий портал
- API для обмена данными между микросервисами
...
- **Интеграция между порталами**: Автоматический импорт данных между порталами через API
...
- **Администрирование**: Импорт данных из преподавательского портала (преподаватели, предметы, связи)

### API-интеграция

Система включает API-эндпоинты для обмена данными между микросервисами:
...
2. Импорт предметов из API
3. Импорт связей преподаватель-предмет из API
